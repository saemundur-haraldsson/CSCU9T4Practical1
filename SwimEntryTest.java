...
public class SwimEntryTest {
    ...
    public void testGetName() {
        ...
        Swimming instance = new Swimming("Alice", 1, 2, 2003, 0, 16, 7, 3,"outdoors");
    ...
    public void testGetDay() {
        ...
        Swimming instance = new Swimming("Alice", 1, 2, 2003, 0, 16, 7, 3,"pool");
        int expResult = 1;
    ...
    /**
     * Test of getDistance method, of class Swimming
     */
    @Test
    public void testGetDistance() {
        System.out.println("getDistance");
        Entry instance = new Swimming("Alice", 1, 2, 2003, 0, 16, 7, 3,"pool");
